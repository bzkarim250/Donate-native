...
const Help = () => {
  ...
  const sendRequest = async () => {
    if (firstName == "" || lastName == "" || email == "" || message == "") {
      ...
      Alert.alert("Warning", `Email is invalid, correct it and try again`, {
        cancelable: true,
      });
    } else {
      setLoading(true);
      try {
        ...
        const response = await axios.post(
          "https://reservation-zeta.vercel.app/customer/request",
          customer,
          config
        );
    ...
    <ScrollView style={styles.scontainer}>
      {isLoading ? (
        <View style={styles.activityIndicator}>
          ...
          <Text style={styles.signup}>Sending...</Text>
        </View>
      ) : (
        <View style={styles.section}>
          <View style={[styles.contactForm, styles.elevation]}>
            ...
            <Text style={styles.subtitle}>Help Request</Text>
